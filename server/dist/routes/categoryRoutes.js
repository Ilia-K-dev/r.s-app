...
// Create category
router.post('/', categoryValidators.create, // Use the correct validation from categoryValidators
validate, // Validate the input
categoryController.createCategory // Handle category creation
);
// Get all categories
router.get('/', categoryController.getCategories // Fetch all categories
);
// Get single category by ID
router.get('/:id', categoryController.getCategoryById // Fetch a category by its ID
);
// Update category
router.put('/:id', categoryValidators.create, // Use the correct validation for category update
validate, // Validate the input
categoryController.updateCategory // Handle category update
);
// Delete category
router.delete('/:id', categoryController.deleteCategory // Handle category deletion
);
